...
namespace EjercicioAdministracion2 {
    ...
    public partial class PracticaDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductosRow AddProductosRow(string Nombre, string Descripcion, decimal PrecioUnitario, int Stock, int StockMinimo, bool Activo, System.DateTime FechaCreacion) {
...
namespace EjercicioAdministracion2.PracticaDataSetTableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Productos] WHERE (([IdProducto] = @Original_IdProducto) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([PrecioUnitario] = @Original_PrecioUnitario) AND ([Stock] = @Original_Stock) AND ([StockMinimo] = @Original_StockMinimo) AND ([Activo] = @Original_Activo) AND ([FechaCreacion] = @Original_FechaCreacion))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Productos] ([Nombre], [Descripcion], [PrecioUnitario], [Stock], [StockMinimo], [Activo], [FechaCreacion]) VALUES (@Nombre, @Descripcion, @PrecioUnitario, @Stock, @StockMinimo, @Activo, @FechaCreacion);
SELECT IdProducto, Nombre, Descripcion, PrecioUnitario, Stock, StockMinimo, Activo, FechaCreacion FROM Productos WHERE (IdProducto = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Productos] SET [Nombre] = @Nombre, [Descripcion] = @Descripcion, [PrecioUnitario] = @PrecioUnitario, [Stock] = @Stock, [StockMinimo] = @StockMinimo, [Activo] = @Activo, [FechaCreacion] = @FechaCreacion WHERE (([IdProducto] = @Original_IdProducto) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([PrecioUnitario] = @Original_PrecioUnitario) AND ([Stock] = @Original_Stock) AND ([StockMinimo] = @Original_StockMinimo) AND ([Activo] = @Original_Activo) AND ([FechaCreacion] = @Original_FechaCreacion));
SELECT IdProducto, Nombre, Descripcion, PrecioUnitario, Stock, StockMinimo, Activo, FechaCreacion FROM Productos WHERE (IdProducto = @IdProducto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdProducto, Nombre, Descripcion, PrecioUnitario, Stock, StockMinimo, Activ" +
                "o, FechaCreacion FROM dbo.Productos";
        ...
        public virtual int Delete(int Original_IdProducto, string Original_Nombre, string Original_Descripcion, decimal Original_PrecioUnitario, int Original_Stock, int Original_StockMinimo, bool Original_Activo, System.DateTime Original_FechaCreacion) {
        ...
        public virtual int Insert(string Nombre, string Descripcion, decimal PrecioUnitario, int Stock, int StockMinimo, bool Activo, System.DateTime FechaCreacion) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((System.DateTime)(Original_FechaCreacion));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Descripcion, decimal PrecioUnitario, int Stock, int StockMinimo, bool Activo, System.DateTime FechaCreacion, int Original_IdProducto, string Original_Nombre, string Original_Descripcion, decimal Original_PrecioUnitario, int Original_Stock, int Original_StockMinimo, bool Original_Activo, System.DateTime Original_FechaCreacion) {
            return this.Update(Nombre, Descripcion, PrecioUnitario, Stock, StockMinimo, Activo, FechaCreacion, Original_IdProducto, Original_Nombre, Original_Descripcion, Original_PrecioUnitario, Original_Stock, Original_StockMinimo, Original_Activo, Original_FechaCreacion, Original_IdProducto);
        }
    }
